...
from funct_1m_full_mov_15a import *
...
#    P20 = [9,11]   # T9
    ...
    Pt_infe = [P1_I, P2_I, P3_I, P4_I, P5_I, P6_I, P7_I, P8_I, P9_I, P10_I, P11_I,
               P12_I, P13_I, P14_I, P15_I, Cas_1, Cas_2, Cas_3]
...
#            U_Pop = [i for j, i in enumerate(U_Pop) if j not in traj_nex[1]]  
...
#            plt.scatter(T1[i][0], T1[i][1], marker=".", s=dot, color=colors[0])
#        for i in range(len(T2)):
#            plt.scatter(T2[i][0], T2[i][1], marker=".", s=dot, color=colors[4])
#        for i in range(len(T3)):
#            plt.scatter(T3[i][0], T3[i][1], marker=".", s=dot, color=colors[1])
#        for i in range(len(T4)):
#            plt.scatter(T4[i][0], T4[i][1], marker=".", s=dot, color=colors[5]) 
#        for i in range(len(T5)):
#            plt.scatter(T5[i][0], T5[i][1], marker=".", s=dot, color=colors[6]) 
#        for i in range(len(T6)):
#            plt.scatter(T6[i][0], T6[i][1], marker=".", s=dot, color=colors[8]) 
#        for i in range(len(T7)):
#            plt.scatter(T7[i][0], T7[i][1], marker=".", s=dot, color=colors[9]) 
#        for i in range(len(T8)):
#            plt.scatter(T8[i][0], T8[i][1], marker=".", s=dot, color=colors[0]) 
#        for i in range(len(T9)):
#            plt.scatter(T9[i][0], T9[i][1], marker=".", s=dot, color=colors[1]) 
#        for i in range(len(T10)):
#            plt.scatter(T10[i][0], T10[i][1], marker=".", s=dot, color=colors[3])
#        for i in range(len(T11)):
#            plt.scatter(T11[i][0], T11[i][1], marker=".", s=dot, color=colors[4])
#        for i in range(len(T12)):
#            plt.scatter(T12[i][0], T12[i][1], marker=".", s=dot, color=colors[5])
#        for i in range(len(T13)):
#            plt.scatter(T13[i][0], T13[i][1], marker=".", s=dot, color=colors[7])
#        for i in range(len(T14)):
#            plt.scatter(T14[i][0], T14[i][1], marker=".", s=dot, color=colors[8])
#        for i in range(len(T15)):
#            plt.scatter(T15[i][0], T15[i][1], marker=".", s=dot, color=colors[9])
#        for i in range(len(T16)):
#            plt.scatter(T16[i][0], T16[i][1], marker=".", s=dot, color=colors[1])
#        for i in range(len(T17)):
#            plt.scatter(T17[i][0], T17[i][1], marker=".", s=dot, color=colors[3])
#        for i in range(len(T18)):
#            plt.scatter(T18[i][0], T18[i][1], marker=".", s=dot, color=colors[4],alpha = alpha3)
#        for i in range(len(pop_fig)):
#            plt.scatter(pop_fig[i][0], pop_fig[i][1], s=s1, color=colors[2], marker='o',
#                                                                        alpha=alpha1)
#            plt.scatter(pop_fig[i][0], pop_fig[i][1], marker="1", s=80, color=colors[2])
...
#        plt.xlim(0, 30)
#        plt.ylim(0, 16)
#        plt.xlabel("\n Supermarket Layout ", fontsize=14)
#        #plt.ylabel("layout y-axis (m)", fontsize=14)
#        #plt.grid(True)
#        plt.xticks([])
#        plt.yticks([])
#    #    ax.savefig('Mar{}.pdf'.format(fig), format='pdf', dpi=1400)
#        plt.show() 
#    #    fig = fig +1
...
plt.xlabel("Number of potential newly infected (15 a, 1 inf)(Total infected {})".format(sum(infec_num)), fontsize=16)
plt.ylabel("Repetition of cases (1 m) (%)", fontsize=16)
plt.ylim(0, 50)
...
#plt.xticks([])
#plt.yticks([])
#ax1.savefig('Test_corr_1m_15a.pdf', format='pdf', dpi=1400)
plt.show() 
...
#        P_init2[i]
#    
#    Pt_infe[P_init2.index(I_Pop[i + 1])] = 1
...
#P_init2 = [P1, P2, P3, P4, P5, P8, P9, P10, P11, P12, P13, P6, P7, P14, P15, ]
#U_FIX = [CO1, CO2, CO3]
#ax=plt.figure(figsize=(10,7), facecolor='w', edgecolor='k') 
#for i in range(len(T1)):
#    plt.scatter(T1[i][0], T1[i][1], marker=".", s=dot, color=colors[0])
...
#    plt.scatter(T17[i][0], T17[i][1], marker=".", s=dot, color=colors[3])
#for i in range(len(T18)):
#    plt.scatter(T18[i][0], T18[i][1], marker=".", s=dot, color=colors[4])
#
...
##for i in range(len(I_Pop)-1):
##    plt.scatter(I_Pop[i+1][0], I_Pop[i+1][1], s=s1, color=colors[3], marker='o',
##                                                                alpha=alpha1)
##    plt.scatter(I_Pop[i+1][0], I_Pop[i+1][1], marker="1", s=dot, color=colors[3])
#for i in range(len(Pt_infe)):
#    if Pt_infe[i] == 1:
##        P_init2[i]           INFECTED
#        plt.scatter(P_init2[i][0], P_init2[i][1], s=s1, color=colors[3],
#                                                       marker='o',alpha=alpha1)
#        plt.scatter(P_init2[i][0], P_init2[i][1], marker="1", s=dot, 
#                                                              color=colors[3])
#    elif Pt_infe[i] == 0:
##        P_init2[i]      UNINFECTED
#        plt.scatter(P_init2[i][0], P_init2[i][1], s=s1, color=colors[2], marker='o',
#                                                                alpha=alpha1)
#        plt.scatter(P_init2[i][0], P_init2[i][1], marker="1", s=80,
#                                                              color=colors[2])
#plt.scatter(I_Pop[0][0], I_Pop[0][1], s=s1, color=colors[3], marker='o',
#                                        alpha = alpha1 +0.2)
#plt.scatter(I_Pop[0][0], I_Pop[0][1], marker="1", s=dot, color=colors[3])
#for i in range(len(U_FIX)):
#    plt.scatter(U_FIX[i][0], U_FIX[i][1], s=s1, color=colors[2], marker='o',
#                                                                alpha=alpha1)
#    plt.scatter(U_FIX[i][0], U_FIX[i][1], marker="1", s=80,
#                                                              color=colors[2])
#plt.xlim(0, 30)
#plt.ylim(0, 16)
#plt.xlabel("\n Supermarket Layout ", fontsize=14)
...
#plt.xticks([])
#plt.yticks([])
##ax.savefig('Marpost.pdf', format='pdf', dpi=1400)
#plt.show() 

#print ('\nNumber of newly possible infected: {} cases'.format(infec_iter ))
#print ('\nEstimated time spend: {} min'.format(time_iter)) # 4 min per traj
