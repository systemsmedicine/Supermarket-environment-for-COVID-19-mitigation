...
from funct_50cm_full_mov_15a import *
...
#    fig = 1
    ...
    #    if traj_nex[1][0] != 0:
#        if traj_nex[1] != [0]:
#            for i in range(len(traj_nex[2])-1):
#                if (traj_nex[2][i+1] in U_Pop):
#                    U_Pop.remove(traj_nex[2][i+1])
...
#        pop_fig = [P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, 
#                                P12, P13, P14, P15,CO1, CO2, CO3]
...
#            Pt_infe[P_init.index(I_Pop[i + 1])] = 1 # check for the counting
...
plt.ylabel("Repetition of cases (50 cm) (%)", fontsize=16)
plt.ylim(0, 50)
...
#plt.xticks([])
#plt.yticks([])
#ax1.savefig('Test_corr_50cm_15a.pdf', format='pdf', dpi=1400)
plt.show() 
    
print ('\nTotal of possible newly infected in 1000 simulations (50 cm): {}'.format(sum(infec_num)) )
