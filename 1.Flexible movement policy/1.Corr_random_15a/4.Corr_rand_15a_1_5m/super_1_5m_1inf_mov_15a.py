...
from funct_1_5m_full_mov_15a import *
...
plt.ylabel("Repetition of cases (1.5 m) (%)", fontsize=16)
plt.ylim(0, 50)
...
#plt.xticks([])
#plt.yticks([])
#ax1.savefig('Test_corr_1_5m_15a.pdf', format='pdf', dpi=1400)
plt.show() 
    
print ('\nTotal of possible newly infected in 1000 simulations (1.5 m): {}'.format(sum(infec_num)) )
