...
from funct_2m_full_mov_50a import *
...
#plt.xticks([])
#plt.yticks([])
#ax1.savefig('Test_corr_2m_50a.pdf', format='pdf', dpi=1400)
plt.show() 
    
print ('\nTotal of possible newly infected in 1000 simulations (2 m, 50a): {}'.format(sum(infec_num)) )
