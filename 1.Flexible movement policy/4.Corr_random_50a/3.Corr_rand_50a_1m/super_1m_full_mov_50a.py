...
from funct_1m_full_mov_50a import *
...
#plt.xticks([])
#plt.yticks([])
#ax1.savefig('Test_corr_1m_50a.pdf', format='pdf', dpi=1400)
plt.show() 
    
print ('\nTotal of possible newly infected in 1000 simulations (1 m, 50a): {}'.format(sum(infec_num)) )
