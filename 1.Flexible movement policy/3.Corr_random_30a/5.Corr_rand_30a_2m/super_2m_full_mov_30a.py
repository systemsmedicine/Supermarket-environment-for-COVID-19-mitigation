...
from funct_2m_full_mov_30a import *
...
#plt.xticks([])
#plt.yticks([])
##ax.savefig('super_2m_30a.pdf', format='pdf', dpi=1400)
#plt.show() 
...
plt.ylabel("Repetition of cases (2 m) (%)", fontsize=16)
plt.ylim(0, 20)
...
#plt.xticks([])
#plt.yticks([])
#ax1.savefig('Test_corr_2m_30a.pdf', format='pdf', dpi=1400)
plt.show() 
    
print ('\nTotal of possible newly infected in 1000 simulations (2 m, 30a): {}'.format(sum(infec_num)) )
