...
from funct_1_5m_full_mov_30a import *
...
#plt.xlim(0, 30)
#plt.ylim(0, 16)
#plt.xlabel("\n Supermarket Layout (30 agents) ", fontsize=14)
##plt.ylabel("layout y-axis (m)", fontsize=14)
##plt.grid(True)
#plt.xticks([])
#plt.yticks([])
##ax.savefig('super_1_5m_30a.pdf', format='pdf', dpi=1400)
#plt.show() 
...
for event in range(sim_cases):
    ...
    P_init = [P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, 
              ...
              P21, P22, P23, P24, P25, P26 ,P27, P28, P29, P30, CO1, CO2, CO3]
...
#plt.xticks([])
#plt.yticks([])
#ax1.savefig('Test_corr_1_5m_30a.pdf', format='pdf', dpi=1400)
plt.show() 
    
print ('\nTotal of possible newly infected in 1000 simulations (1.5 m, 30a): {}'.format(sum(infec_num)) )
