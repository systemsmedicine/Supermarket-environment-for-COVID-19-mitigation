...
from funct_1m_full_mov_30a import *
...
#plt.xticks([])
#plt.yticks([])
#ax1.savefig('Test_corr_1m_30a.pdf', format='pdf', dpi=1400)
plt.show() 
    
print ('\nTotal of possible newly infected in 1000 simulations (1 m, 30a): {}'.format(sum(infec_num)) )
