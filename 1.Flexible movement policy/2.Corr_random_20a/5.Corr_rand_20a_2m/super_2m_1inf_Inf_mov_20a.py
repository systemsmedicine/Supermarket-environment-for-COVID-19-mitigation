...
from funct_2m_1inf_Inf_mov_20a import *
...
#plt.xticks([])
#plt.yticks([])
ax1.savefig('Test_corr_2m_20a.pdf', format='pdf', dpi=1400)
plt.show() 
...
#time_dist = []   
#for i in range(41):
#    time_dist.append(time_iter.count(i))

#tim_num = []   
#for i in range(len(time_dist)):
#    tim_num.append(time_dist[i]*i)
