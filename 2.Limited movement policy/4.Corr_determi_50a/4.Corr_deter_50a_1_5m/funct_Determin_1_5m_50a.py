...
#                       Trajectories
#T1 = [[1,2],[2,2],[3,2],[4,2],[5,2],[6,2],[7,2],[8,2],[9,2],[10,2],
#      [11,2],[12,2]]
...
T1 = []
sis_1 = 12 * multi
for i in range(1, sis_1-3):
    T1.append([(i*addi)+0,2])
    
T2 = []
sis_2 = 15 * multi
for i in range(1, sis_2-4):
    T2.append([(i*addi)+12,2])
for i in range(0, 2):
    T2.append([27,(i*addi)+3.5])
T2.append([27,6])

T3 = []
sis_3 = 4 * multi
for i in range(0, sis_3-1):
    T3.append([27,(i*addi)+7])

#T4 = [[26,6],[25,6],[24,6],[23,6],[22,6],[21,6],[20,6]]
T4 = []
sis_4 = 7 * multi 
for i in range(sis_4-2, 0, -1):
    T4.append([(i*addi)+18.5,6])

#T5 = [[19.5,6],[18,6],[17,6],[16,6],[15,6],[14,6],[13,6],[12,6]]
T5 = []
sis_5 = 8 * multi
for i in range(sis_5-3, 0,-1):
    T5.append([(i*addi)+10.5,6])

#T6 = [[27,10.5],[27,12],[27,13],[27,14],[26,14],[25,14],[24,14],[23,14],[22,14],
#                                                              [21,14],[20,14]]
T6 = []
sis_6 = 4 * multi
for i in range(0, sis_6-1):
    T6.append([27,(i*addi)+11])
for i in range(5, 0, -1):
    T6.append([(i*addi)+18.5,14])

#T7 = [[26.5,10],[25,10],[24,10],[23,10],[22,10],[21,10],[20,10]]
T7 = []
sis_7 = 7 * multi
for i in range(sis_7-2, 0,-1):
    T7.append([(i*addi)+18.5,10])

#T8 = [[20,10.5],[20,12],[20,13.5]]
T8 = []
sis_8 = 4 * multi
for i in range(0, sis_8-2):
    T8.append([20,(i*addi)+11.5])

#T9 = [[20,6.5 7],[20,8],[20,9.5]]
T9 = []
sis_9 = 4 * multi
for i in range(0, sis_9-2):
    T9.append([20,(i*addi)+7.5])

#T10= [[19.5,10],[18,10],[17,10],[16,10],[15,10],[14,10],[13,10],[12,10]]
T10 = []
sis_10 = 8 * multi
for i in range(sis_10-3, 0,-1):
    T10.append([(i*addi)+10.5,10])

#T11= [[19,14],[18,14],[17,14],[16,14],[15,14],[14,14],[13,14],[12,14]]
T11 = []
sis_11 = 8 * multi
for i in range(sis_11-3, 0,-1):
    T11.append([(i*addi)+10.5,14])

#T12= [[12,11],[12,12],[12,13]]
T12 = []
sis_12 = 3 * multi
for i in range(0, sis_12-1):
    T12.append([12,(i*addi) + 11.5])

#T13= [[12,7],[12,8],[12,9]]
T13 = []
sis_13 = 3 * multi
for i in range(0, sis_13-1):
    T13.append([12,(i*addi) + 7.5])

#T14= [[12,3],[12,4],[12,5]]
T14 = []
sis_14 = 3 * multi
for i in range(0, sis_14-1):
    T14.append([12,(i*addi) + 3.5])
...
sis_15 = 8 * multi
T15.append([11,7])
for i in range(sis_15-4, 0,-1):
    T15.append([(i*addi)+3.5,8])

#T16= [[11,10.5],[10,11],[9,11],[8,11],[7,11],[6,11],[5,11]]
T16 = []
sis_16 = 6 * multi
T16.append([10.7,10.5])
#T16.append([11.4,10.5])
#T16.append([11.1,10.8])
for i in range(sis_16-2, 0,-1):
    T16.append([(i*addi)+3.5,11])

#T17= [[11,14],[10,14],[9,14],[8,14],[7,14],[6,14],[5,14]]
T17 = []
sis_17 = 7 * multi
for i in range(sis_17-2, 0,-1):
    T17.append([(i*addi)+3.5,14])
    
T18 = []
sis_18 = 8 * multi
for i in range(sis_18-2, 0,-1):
    T18.append([4,(i*addi)+5])
...
#                print(f'T3-, {P}')
    ...
    if traj == T8[::-1]:
        ind = T8[::-1].index(P) + paso
        if ind <= (len(T8[::-1])-1):
           P = T8[::-1][T8[::-1].index(P) + paso]
           next_traj = T8[::-1]
##           print(f'T8-, {P}')
        else:
            if (random.random() < 0.5):
...
#                print(f'T10-, {P}')
    ...
    if traj == T9[::-1]:
        ind = T9[::-1].index(P) + paso
        if ind <= (len(T9[::-1])-1):
           P = T9[::-1][T9[::-1].index(P) + paso]
           next_traj = T9[::-1]
##           print(f'T9-, {P}')
        else:
            if (random.random() < 0.5):
...
#            print(f'T8-, {P}')
    ...
    if traj == T12[::-1]:
        ind = T12[::-1].index(P) + paso
        if ind <= (len(T12[::-1])-1):
           P = T12[::-1][T12[::-1].index(P) + paso]
           next_traj = T12[::-1]
##           print(f'T12-, {P}')
        else:
#            next_traj = T10[::-1]
...
#            print(f'T10-, {P}')
    ...
    if traj == T13[::-1]:
        ind = T13[::-1].index(P) + paso
        if ind <= (len(T13[::-1])-1):
           P = T13[::-1][T13[::-1].index(P) + paso]
           next_traj = T13[::-1]
##           print(f'T13-, {P}')
        else:
#            next_traj = T5[::-1]
