...
sis_6 = 4 * ext
for i in range(0, 13):
    T6.append([27,(i*addi)+10.2])
for i in range(24, 0, -1):
    T6.append([(i*addi)+19.7,14])

#T7 = [[26.5,10],[25,10],[24,10],[23,10],[22,10],[21,10],[20,10]]
T7 = []
sis_7 = 7 * ext
for i in range(sis_7-4, 0,-1):
    T7.append([(i*addi)+19.7,10])

#T8 = [[20,10.5],[20,12],[20,13.5]]
T8 = []
sis_8 = 4 * ext
for i in range(0, sis_8-3):
    T8.append([20,(i*addi)+10.3])

#T9 = [[20,6.5 7],[20,8],[20,9.5]]
T9 = []
sis_9 = 4 * ext
for i in range(0, sis_9-3):
    T9.append([20,(i*addi)+6.3])

#T10= [[19.5,10],[18,10],[17,10],[16,10],[15,10],[14,10],[13,10],[12,10]]
T10 = []
sis_10 = 8 * ext
for i in range(sis_10-5, 0,-1):
    T10.append([(i*addi)+11.7,10])

#T11= [[19,14],[18,14],[17,14],[16,14],[15,14],[14,14],[13,14],[12,14]]
T11 = []
sis_11 = 8 * ext
for i in range(sis_11-5, 0,-1):
    T11.append([(i*addi)+11.7,14])

#T12= [[12,11],[12,12],[12,13]]
T12 = []
sis_12 = 3 * ext
for i in range(0, sis_12+1):
    T12.append([12,(i*addi) + 10.3])

#T13= [[12,7],[12,8],[12,9]]
T13 = []
sis_13 = 3 * ext
for i in range(0, sis_13+1):
    T13.append([12,(i*addi) + 6.3])

#T14= [[12,3],[12,4],[12,5]]
T14 = []
sis_14 = 3 * ext
for i in range(0, sis_14+1):
    T14.append([12,(i*addi) + 2.2])
