...
from funct_Determin_30cm_30a import *
...
#plt.xticks([])
#plt.yticks([])
#ax1.savefig('Test_determi_30cm_30a.pdf', format='pdf', dpi=1400)
plt.show() 
    
print ('\nTotal of possible newly infected in 1000 simulations (30 cm, 30a): {}'.format(sum(infec_num)) )
