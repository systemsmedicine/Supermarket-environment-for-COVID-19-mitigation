...
for i in range(1, sis_2):
    T2.append([(i*0.5)+12,2])
for i in range(0, 4*2+1):
    T2.append([27,(i*0.5)+2])

T3 = []
sis_3 = 4 * 2
for i in range(0, sis_3):
    T3.append([27,(i*0.5)+6.5])

#T4 = [[26,6],[25,6],[24,6],[23,6],[22,6],[21,6],[20,6]]
T4 = []
sis_4 = 7 * 2 
for i in range(sis_4, 0, -1):
    T4.append([(i*0.5)+19.5,6])

#T5 = [[19.5,6],[18,6],[17,6],[16,6],[15,6],[14,6],[13,6],[12,6]]
T5 = []
sis_5 = 8 * 2
for i in range(sis_5, 0,-1):
    T5.append([(i*0.5)+11.5,6])
