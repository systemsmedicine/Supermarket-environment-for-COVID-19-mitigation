...
from funct_Determin_2m_30a import *
...
plt.xlabel("Number of potential newly infected (30a)(Total infected {})".format(sum(infec_num)), fontsize=16)
...
#plt.xticks([])
#plt.yticks([])
#ax1.savefig('Test_determi_2m_30a.pdf', format='pdf', dpi=1400)
plt.show() 
