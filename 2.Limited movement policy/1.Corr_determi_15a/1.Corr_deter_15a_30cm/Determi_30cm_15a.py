...
from funct_Determi_30cm_15a import *
...
#        if (step == 15 or step == 30 or step == 45 or step == 60 or step == 85
#            or step == 105 or step == 115 or step == 130 or step == 145 or step == 160):
#        
#        #_________________________________________________________________
#            ax=plt.figure(figsize=(10,7), facecolor='w', edgecolor='k') 
#            #plt.scatter(I_Pop[0][0], I_Pop[0][1], marker="1", s=dot, color=colors[3])
...
plt.ylabel("Repetition of cases (30 cm, determin) (%)", fontsize=16)
plt.ylim(0, 50)
plt.rc('xtick', labelsize=14)    # fontsize of the tick labels
plt.rc('ytick', labelsize=14) 
#ax1.savefig('Test_determi_30cm_15a.pdf', format='pdf', dpi=1400)
plt.show() 
    
print ('\nTotal of possible newly infected in 1000 simulations (30 cm): {}'.format(sum(infec_num)) )
