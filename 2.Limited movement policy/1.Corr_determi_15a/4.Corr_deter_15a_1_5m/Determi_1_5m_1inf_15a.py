...
from funct_Determi_1_5m_15a import *
...
#        if (step == 5 or step == 10 or step == 15 or step == 20 or step == 25
#        or step == 30 or step == 35 or step == 40 or step == 45 or step == 50):
#        
#        #_________________________________________________________________
#            ax=plt.figure(figsize=(10,7), facecolor='w', edgecolor='k') 
#            #plt.scatter(I_Pop[0][0], I_Pop[0][1], marker="1", s=dot, color=colors[3])
...
plt.ylabel("Repetition of cases (1.5 m, determin) (%)", fontsize=16)
plt.ylim(0, 50)
...
#plt.xticks([])
#plt.yticks([])
#ax1.savefig('Test_determi_1_5m_15a.pdf', format='pdf', dpi=1400)
plt.show() 
